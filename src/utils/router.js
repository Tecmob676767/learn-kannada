...
export const ROUTE_MAP = {
  ...
  'techpark': 'techparkkannada',
  'signboards': 'signboarddecoder',
  'metro': 'metronavigator',
  'dialects': 'dialectexplorer',
  'tracing': 'animatedtracing',
  'comics': 'comicbuilder',
  'subtitles': 'songsubtitlereader',
  'offlinepacks': 'offlinepwapack',
  'customdeck': 'customdeckcreator',
  'yakshagana': 'yakshaganatheater',
...
export const PAGE_TO_ROUTE = {
  ...
  techparkkannada: 'techpark',
  signboarddecoder: 'signboards',
  metronavigator: 'metro',
  dialectexplorer: 'dialects',
  animatedtracing: 'tracing',
  comicbuilder: 'comics',
  songsubtitlereader: 'subtitles',
  offlinepwapack: 'offlinepacks',
  customdeckcreator: 'customdeck',
